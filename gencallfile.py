...
try:
	asteriskParams = {'numbertocall1':sys.argv[1],
	'numbertocall2':sys.argv[2], 
	'context': 'listen',
	'extension':'s', 
	'variables':'', 
	'touchtime':''}
...
def makeCallFile(numtocall):
	...
	scf.write("Set: CONFID=" + str(asteriskParams['numbertocall1'][-4:]) + str(asteriskParams['numbertocall2'][-4:]) + " \n")
...
makeCallFile(asteriskParams['numbertocall1'])
makeCallFile(asteriskParams['numbertocall2'])
